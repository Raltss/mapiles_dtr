                        ...
                        {employees.length === 0 ? (
                            ...
                            <>
                                ...
                                <div className="rounded-lg border bg-muted/30 px-4 py-3 text-sm text-muted-foreground">
                                    {selectedEmployee
                                        ? `Encoding attendance for ${selectedEmployee.fullName} in ${selectedMonthLabel} ${selectedYear}. Only scheduled workdays appear below.`
                ...
                {employees.length > 0 && selectedEmployee ? (
                    <Card className="w-full max-w-5xl">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Enter the time in and time out for each scheduled
                                workday in {selectedMonthLabel} {selectedYear}.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            {monthDays.length === 0 ? (
